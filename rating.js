!(function (t) {
    ...
    function e(a) {
        ...
        return t[a].call(s.exports, s, s.exports, e), (s.l = !0), s.exportas;
    }
    (e.m = t),
        (e.c = r),
        (e.d = function (t, r, a) {
                ...
                return this.each(function () {
                    $(this).attr("rating") && $(this).empty(),
                        ...
                        this.readonly ||
                            ($(this).on("mousemove", function (r) {
                                ...
                                if (this.getStars().index(r.target) >= 0)
                                    if (a) {
                                        $(this)
                                            .find("i")
                                            .attr("class", t.emptyStar ? t.emptyStar : e.emptyStar);
                                        let a = 0.5;
                                        $(this)
                                            .find("i")
                                        ...
                                        for (let r = 0; r < this.getStars().length; r++)
                                            r + 0.5 < s ? $(this.getStars()[r]).attr("class", t.filledStar ? t.filledStar : e.filledStar) : r < s && $(this.getStars()[r]).attr("class", t.halfStar ? t.halfStar : e.halfStar);
                                    } else {
                                        $(this)
                                            .find("i")
                                            .attr("class", t.emptyStar ? t.emptyStar : e.emptyStar);
                            ...
                            $(this).on("click", function (r) {
                                ...
                                (t.click ? t.click : e.click)({ stars: this.stars, event: r });
                            }));
                    ...
                    for (let a = 0; a < r; a++) {
                        let r = $("<i></i>")
                            ...
                            .appendTo($(this));
                        if ((this.readonly || r.css({ cursor: "pointer" }), a > 1e3)) return;
                    }
                    if (
                        ((this.printStars = function () {
                            if (t.half ? t.half : e.half) {
                                ...
                                for (let r = 0; r < this.stars; r++)
                                    r < this.stars - 0.5 ? $(this.getStars()[r]).attr("class", t.filledStar ? t.filledStar : e.filledStar) : $(this.getStars()[r]).attr("class", t.halfStar ? t.halfStar : e.halfStar);
                            } else {
                                $(this)
                                    .find("i")
                                    .attr("class", t.emptyStar ? t.emptyStar : e.emptyStar);
                        ...
                        this.printStars(), (t.click ? t.click : e.click)({ stars: this.stars });
                    }
                });
            },
        }),
